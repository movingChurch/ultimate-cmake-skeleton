...
function(set_package_directories PACKAGE_NAME MODULE_NAME)
  set(${MODULE_NAME}_SOURCE_DIRECTORY ${CMAKE_SOURCE_DIR}/externals/install/${PACKAGE_NAME}/source PARENT_SCOPE)
  set(${MODULE_NAME}_BUILD_DIRECTORY ${CMAKE_SOURCE_DIR}/externals/install/${PACKAGE_NAME}/build PARENT_SCOPE)
  set(${MODULE_NAME}_INSTALL_DIRECTORY ${CMAKE_SOURCE_DIR}/externals/install/${PACKAGE_NAME}/${CMAKE_BUILD_TYPE} PARENT_SCOPE)
endfunction()
